"""
Source code link https://github.com/daniel-code/TubeViT/blob/main/tubevit/positional_encoding.py
"""
...
def get_3d_sincos_pos_embed(
    ...
    pos_embed_temporal = torch.repeat_interleave(
        pos_embed_temporal, grid_h_size * grid_w_size, dim=1
    )
